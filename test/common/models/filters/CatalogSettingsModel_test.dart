...
void main() {
  ...
  test("When copying order then values are mantained", () {
    CatalogSettingsModel original = CatalogSettingsModel(FakeModelFactory.randomFilter(), OrderCriteriaModelFactory.priceAscending("lbPriceAsc"));
    CatalogSettingsModel copy = original.copyWith(order: OrderCriteriaModelFactory.priceDescending("lbPriceDesc"));
  ...
  test("When copying filter then values are mantained", () {
    CatalogSettingsModel original = CatalogSettingsModel(FakeModelFactory.randomFilter(), OrderCriteriaModelFactory.priceAscending("lbPriceAsc"));
    CatalogSettingsModel copy = original.copyWith(filter: FakeModelFactory.randomFilter());
